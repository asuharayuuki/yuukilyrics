...
class _TaggingButtonState extends State<TaggingButton> {
  ...
  void _lightImpact() {
    if (_supportsHaptics && widget.lyricsState.hapticFeedbackEnabled) {
      HapticFeedback.lightImpact();
    }
  }

  void _finishTaggingPress() {
    if (_tapDownTime != null) {
      if (_hapticOnRelease) _lightImpact();
          ...
          child: Material(
            ...
            child: InkWell(
              ...
              onTapDown: (_) {
                ...
                _hapticOnRelease = widget.lyricsState.activeCursorHasEndTag;
                _lightImpact();
                widget.lyricsState.recordTimestamp(
                  _tapDownTime!,
                  advance: false,
                );
              },
              onTapUp: (_) => _finishTaggingPress(),
              onTapCancel: _finishTaggingPress,
